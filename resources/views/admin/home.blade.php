...
<div class="row">
  <div class="col-md-6 col-lg-6">
    <a  style="text-decoration: none;">
      ...
      <div class="row">
        <div class="col-12">
          <a href="/managment/ajouter/post" class="btn btn-info ajouter_post"> <i class="fa fa-edit"></i> Ajouter un post</a><br><br>
        </div>
        ...
        <div class="col-md-12">
                  ...
                  <tr>
                    ...
                    <tbody>
                      @foreach($posts as $post)
                        <tr>
                          <td><img src="{{asset('admin/media/'.$post->picture)}}" alt="" style="max-height: 50px; max-width: 50px;"></td>
                          <td>{{$post->title}}</td>
                          <td>{{ (new DateTime($post->created_at))->format('d/m/Y') }}</td>
                          <td>{{substr($post->description,0,45)}}{{ (strlen($post->description) >= 45) ? '...' : '' }}</td>
                          <td valign="center">
                            <div align="center" class="tools">

                              <a href="/managment/voir/post/{{$post->id}}" class="btn bg-green btn-flat updated_post" style="width: 10px;">
                                <i class="fa fa-eye"></i>
                              </a> 
                              
                              <a href="/managment/delete/post/{{$post->id}}" class="btn bg-orange btn-flat delete_post" style="width: 10px;">
          ...
          <script type="text/javascript">
            ...
            $(document).on("click",".ajouter_post", function(e){
              e.preventDefault();
              var a=$(this);
              $.ajax({
                method: 'get',
            ...
            $(document).on("click",".updated_post", function(e){
              e.preventDefault();
              var a=$(this);
              $.ajax({
                method: 'get',
