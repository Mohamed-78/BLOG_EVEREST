@extends('admin.layouts.default',['title' => 'COMMENTAIRES'])

@section('content')
<div class="app-title">
  <div>
    <h1 style="font-size: 16px;"><i class="fa fa-dashboard"></i> LISTE DES COMMENTAIRES : {{$commentaires->count()}}</h1>
  </div>
  ...
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-title-w-btn">
        <h3 class="title">Tous les commentaires</h3></div>
        <div class="tile-body">
          ...
          <table class="table table-hover table-bordered" id="sampleTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$commentaire->first_name}}</td>
                <td>{{substr($commentaire->content,0,45)}}{{ (strlen($commentaire->content) >= 45) ? '...' : '' }}</td>
                <td valign="center">
                  <div align="center" class="tools">
                    <a href="/managment/voir/commentaire/{{$commentaire->id}}" class="btn bg-green btn-flat voir_docoment" style="width: 10px;">
                      <i class="fa fa-eye"></i>
                    </a> 

                    <a href="/managment/delete/commentaire/{{$commentaire->id}}" class="btn bg-orange btn-flat delete_commentaire" style="width: 10px;">
...
<script type="text/javascript">
  ...
  $(document).on("click",".delete_commentaire", function(e){
    e.preventDefault();
    var a=$(this);
    swal({
      title: "SUPPRESSION",
      text: "Êtes-vous sûr d'effectuée cette opération?",
      type: "warning",
      ...
      if (isConfirm) {
        swal("Sppression!", "Commentaire supprimé avec succès .", "success");
